...
template_1 = "report_template_ChartDoughnut.html"
template_2 = "report_template _ChartBar.html"
template_3 = "report_template _ChartLine.html"

DEFAULT_TEMPLATE = os.path.join(os.path.dirname(__file__), "template", template_1)
...
class _TestInfo(object):
    ...
    def __init__(self, test_result, test_method, outcome=SUCCESS,
        ...
        self.test_step = getattr(test_method, 'step', [])
